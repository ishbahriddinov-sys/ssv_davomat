...
class Settings(BaseSettings):
    ...
    # Пароль первичного администратора панели (username=admin). Задаётся ТОЛЬКО через
    # окружение. Пусто → в DEBUG используется "admin123", в production генерируется
    # случайный и печатается в лог один раз (чтобы не зашивать известный пароль).
    admin_password: str = ""
